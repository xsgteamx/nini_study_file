...
def baidu(company):
    ...
    for i in range(len(title)):
        db = pymysql.connect(host='localhost', port=3306, user='root', password='123456', database='pachong', charset='utf8')
        cur = db.cursor()
        sql = 'INSERT INTO post_data(company,title,href,source,date) VALUES (%s,%s,%s,%s,%s)'
